...
// This TU supplies the PostgreSQL half of test_fk_column_name_orderby_aggregate_body.h;
// test_fk_column_name_orderby_aggregate_sqlite.cpp supplies the other half. See that header's own comment
