...
// This TU supplies the PostgreSQL half of test_many_to_many_multi_body.h;
// test_many_to_many_multi_sqlite.cpp supplies the other half. See that header's own comment
