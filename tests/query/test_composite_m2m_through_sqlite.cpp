...
// This TU supplies the SQLite half of test_composite_m2m_through_body.h;
// test_composite_m2m_through_pg.cpp supplies the other half. See that header's own comment
