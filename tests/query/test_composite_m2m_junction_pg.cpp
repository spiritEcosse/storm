...
// This TU supplies the PostgreSQL half of test_composite_m2m_junction_body.h;
// test_composite_m2m_junction_sqlite.cpp supplies the other half. See that header's own comment
