...
// This TU supplies the SQLite half of test_aggregate_optional_body.h;
// test_aggregate_optional_pg.cpp supplies the other half. See that header's own comment
