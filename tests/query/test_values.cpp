...
TYPED_TEST(ValuesTest, WithWhereSingleField) {
    ...
    auto result = queryset.where(fields::Person.age > 22).template values<^^Person::name>().execute();
...
TYPED_TEST(ValuesTest, WithComplexWhere) {
    ...
    auto result = queryset.where(fields::Person.age.between(25, 35)).template values<^^Person::name>().execute();
    ASSERT_TRUE(result.has_value());
...
TYPED_TEST(ValuesTest, WithWhereNoResults) {
    ...
    auto result = queryset.where(fields::Person.age > 100).template values<^^Person::name>().execute();
    ASSERT_TRUE(result.has_value());
...
TYPED_TEST(ValuesTest, DifferentWhereExpressionsWithCaching) {
    ...
    // Query 1: age > 25
    auto result1 = queryset.where(fields::Person.age > 25).template values<^^Person::name>().execute();
    ...
    // Query 2: age > 35
    auto result2 = queryset.where(fields::Person.age > 35).template values<^^Person::name>().execute();
