...
// This TU supplies the PostgreSQL half of test_aggregate_having_body.h;
// test_aggregate_having_sqlite.cpp supplies the other half. See that header's own comment
