...
// This TU owns the grouped family (chain / distinct / group_*).
// NOLINTNEXTLINE(cppcoreguidelines-macro-usage) - #embed needs a literal filename
#define STORM_UNIFIED_CASES_FILE "test_cases/unified_cases_grouped.json"
...
STORM_REGISTER_UNIFIED_YAML_SUITE(Grouped, "UnifiedYamlGroupedTest")
