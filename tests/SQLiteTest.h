...
struct Author {
  ...
  Author(const std::string &n, int a, const std::string &e, int id = 0,
         bool active = true, double rating = 0.0, float score = 0.0,
         const std::string &middleName = "", const std::string &biography = "")
      : id(id), name(n), age(a), email(e), is_active(active), rating(rating),
        score(score), middleName(middleName), biography(biography) {}
};
...
template <> struct ::refl::type_info<Author> {
  ...
  using descriptor = ::refl::meta::type_descriptor<
      Author, ::refl::detail::fixed_string{"Author"},
      ::refl::meta::member_descriptor<&Author::id,
                                      ::refl::detail::fixed_string{"id"}>,
      ::refl::meta::member_descriptor<&Author::name,
                                      ::refl::detail::fixed_string{"name"}>,
      ::refl::meta::member_descriptor<&Author::age,
                                      ::refl::detail::fixed_string{"age"}>,
      ::refl::meta::member_descriptor<&Author::email,
                                      ::refl::detail::fixed_string{"email"}>,
      ::refl::meta::member_descriptor<
          &Author::is_active, ::refl::detail::fixed_string{"is_active"}>,
      ::refl::meta::member_descriptor<&Author::rating,
                                      ::refl::detail::fixed_string{"rating"}>,
      ::refl::meta::member_descriptor<&Author::score,
                                      ::refl::detail::fixed_string{"score"}>,
      ::refl::meta::member_descriptor<
          &Author::middleName, ::refl::detail::fixed_string{"middleName"}>,
      ::refl::meta::member_descriptor<
          &Author::biography, ::refl::detail::fixed_string{"biography"}>>;
};

template <> struct ::refl::type_info<Post> {
  static constexpr bool has_reflection = true;
  using descriptor = ::refl::meta::type_descriptor<
      Post, ::refl::detail::fixed_string{"Post"},
      ::refl::meta::member_descriptor<&Post::id,
                                      ::refl::detail::fixed_string{"id"}>,
      ::refl::meta::member_descriptor<&Post::title,
                                      ::refl::detail::fixed_string{"title"}>,
      ::refl::meta::member_descriptor<&Post::content,
                                      ::refl::detail::fixed_string{"content"}>,
      ::refl::meta::member_descriptor<
          &Post::author_id, ::refl::detail::fixed_string{"author_id"}>,
      ::refl::meta::member_descriptor<&Post::views,
                                      ::refl::detail::fixed_string{"views"}>>;
};
...
protected:
  ...
  void setupTestData() {
    ...
    Author alice("Alice Smith", 25, "alice@example.com", 0, true, 4.5, 85.5,
                 "Alice", "Alice biography");
    Author bob("Bob Johnson", 35, "bob@example.com", 0, true, 5.0, 90.0, "Bob",
               "Bob biography");
    Author charlie("Charlie Brown", 30, "charlie@example.com", 0, true, 4.0,
                   80.0, "Charlie", "Charlie biography");
    Author diana("Diana Prince", 28, "diana@example.com", 0, true, 5.5, 95.0,
                 "Diana", "Diana biography");
    ...
    // Charlie's posts
    Post charlie_post1("Charlie's First Post", "Content C1", charlie_id, 0,
                       120);
    Post charlie_post2("Charlie's Second Post", "Content C2", charlie_id, 0,
                       180);
    Post charlie_post3("Charlie's Third Post", "Content C3", charlie_id, 0,
                       240);
    Post charlie_post4("Charlie's Fourth Post", "Content C4", charlie_id, 0,
                       300);
    ...
    std::vector<Post> posts = {alice_post1,   alice_post2,   alice_post3,
                               bob_post1,     bob_post2,     charlie_post1,
                               charlie_post2, charlie_post3, charlie_post4,
...
void AssertResultsMatch(const ExpectedValueVectorMap &actual_result,
  ...
  ASSERT_TRUE(actual_result.has_value())
      << "failed with error: " << actual_result.error();
  ...
  for (size_t expected_idx = 0; const auto &expected : expected_results) {
    ...
    auto find_match = [&](const auto &actual_with_idx) -> bool {
      ...
      return std::ranges::all_of(expected, [&](const auto &expected_pair) {
        ...
        return actual.contains(key) &&
               VariantsEqual(actual.at(key), expected_val);
      });
    };
    ...
    if (!found_match) {
      ...
      auto error_msg = std::format(
          ...
          "Actual results:\n",
          expected_idx, build_map_string(expected));
...
TEST_F(ORMTest, InsertSingleObject) {
  ...
  EXPECT_TRUE(result.has_value())
      << "Insert should return a valid ID" << result.error();
...
TEST_F(ORMTest, InsertMultipleObjects) {
  ...
  EXPECT_TRUE(ids.has_value())
      << "Insert should return a valid ID" << ids.error();
  EXPECT_EQ(ids.value().size(), authors.size())
      << "Should return an ID for each inserted object";
...
TEST_F(ORMTest, InsertEmptyVector) {
  ...
  EXPECT_TRUE(ids.has_value())
      << "Inserting empty vector should return empty vector of IDs"
      << ids.error();
}
...
TEST_F(ORMTest, InsertExceptionHandling) {
  ...
  EXPECT_TRUE(result.has_value())
      << "Should return valid ID or -1 on error" << result.error();
}
...
TEST_F(ORMTest, UpdateSingleObject) {
  ...
  ASSERT_TRUE(inserted_id.has_value())
      << "Insert should return a ID" << inserted_id.error();
  ...
  EXPECT_TRUE(result.has_value())
      << "Update should return a bool" << result.error();
...
TEST_F(ORMTest, UpdateEmptyVector) {
  ...
  EXPECT_TRUE(result.has_value())
      << "Updating empty vector should return true" << result.error();
  EXPECT_TRUE(result.value());
}
...
TEST_F(ORMTest, RemoveSingleObject) {
  ...
  ASSERT_TRUE(inserted_id.has_value())
      << "Insert should return a valid ID" << inserted_id.error();
  ASSERT_GT(inserted_id.value(), 0);
  ...
  EXPECT_TRUE(result.has_value())
      << "Remove should return a bool" << result.error();
  EXPECT_TRUE(result.value());
}
...
TEST_F(ORMTest, RemoveEmptyVector) {
  ...
  EXPECT_FALSE(result.has_value())
      << "Remove should return an error for empty vector";
...
TEST_F(ORMTest, RemoveAll) {
  ...
  EXPECT_TRUE(result.has_value())
      << "Select should return a value" << result.error();
  ...
  EXPECT_TRUE(result2.has_value())
      << "Remove should return a bool" << result2.error();
  ...
  EXPECT_TRUE(result3.has_value())
      << "Select should return a value" << result3.error();
...
TEST_F(ORMTest, RemoveByCondition) {
  ...
  auto result2 =
      QuerySet<Author>(conn).where(Field<&Author::age>() > 30).select_all();
  EXPECT_TRUE(result2.has_value())
      << "Select should return a value" << result2.error();
  ...
  auto result3 =
      QuerySet<Author>(conn).where(Field<&Author::age>() > 30).remove();
  EXPECT_TRUE(result3.has_value())
      << "Remove should return a bool" << result3.error();
  EXPECT_TRUE(result3.value());

  // Verify only matching authors were deleted
  auto result4 = QuerySet<Author>(conn).select_all();
  EXPECT_TRUE(result4.has_value())
      << "Select should return a value" << result4.error();
...
TEST_F(ORMTest, QuerySetCopy) {
  ...
  ASSERT_TRUE(youngAuthors.has_value())
      << "Select should return a value" << youngAuthors.error();
  auto seniorAuthors = seniorAuthorsQuery.select_all();
  ASSERT_TRUE(seniorAuthors.has_value())
      << "Select should return a value" << seniorAuthors.error();
  ...
  ASSERT_TRUE(activeAuthors.has_value())
      << "Select should return a value" << activeAuthors.error();
  for (const auto &author : activeAuthors.value()) {
    EXPECT_TRUE(author.is_active);
  }

  // Verify that we have the correct number of results
  EXPECT_EQ(youngAuthors.value().size() + seniorAuthors.value().size(),
            activeAuthors.value().size());
}
...
TEST_F(ORMTest, QuerySetCopyConstructorDeepCopy) {
  ...
  ASSERT_TRUE(originalResults.has_value())
      << "Select should return a value" << originalResults.error();
  auto copiedResults = copiedQuery.select_all();
  ASSERT_TRUE(copiedResults.has_value())
      << "Select should return a value" << copiedResults.error();
  ...
  ASSERT_TRUE(newOriginalResults.has_value())
      << "Select should return a value" << newOriginalResults.error();
  auto newCopiedResults = copiedQuery.select_all();
  ASSERT_TRUE(newCopiedResults.has_value())
      << "Select should return a value" << newCopiedResults.error();
...
TEST_F(ORMTest, QuerySetCopyConstructorMembersVerification) {
  ...
  auto whereQuery =
      QuerySet<Author>(conn).where(Field<&Author::age>() > 25); // Greater than
  ...
  ASSERT_TRUE(whereResults.has_value())
      << "Select should return a value" << whereResults.error();
  ASSERT_TRUE(whereCopyResults.has_value())
      << "Select should return a value" << whereCopyResults.error();
  EXPECT_EQ(whereResults.value().size(), whereCopyResults.value().size());

  // Modify copy and verify independence
  whereQueryCopy.where(
      Field<&Author::email>() ==
      "alice@example.com"); // Use a specific email to ensure different results
  auto whereQueryResults = whereQuery.select_all();
  auto whereQueryCopyResults = whereQueryCopy.select_all();
  ASSERT_TRUE(whereQueryResults.has_value())
      << "Select should return a value" << whereQueryResults.error();
  ASSERT_TRUE(whereQueryCopyResults.has_value())
      << "Select should return a value" << whereQueryCopyResults.error();
  EXPECT_NE(whereQueryResults.value().size(),
            whereQueryCopyResults.value().size());
  ...
  ASSERT_TRUE(orderResults.has_value())
      << "Select should return a value" << orderResults.error();
  auto orderCopyResults = orderQueryCopy.select_all();
  ASSERT_TRUE(orderCopyResults.has_value())
      << "Select should return a value" << orderCopyResults.error();
  ...
  ASSERT_TRUE(newOrderResults.has_value())
      << "Select should return a value" << newOrderResults.error();
  ...
  ASSERT_TRUE(distinctResults.has_value())
      << "Select should return a value" << distinctResults.error();
  ASSERT_TRUE(distinctCopyResults.has_value())
      << "Select should return a value" << distinctCopyResults.error();
  ...
  ASSERT_TRUE(limitResults.has_value())
      << "Select should return a value" << limitResults.error();
  ASSERT_TRUE(limitCopyResults.has_value())
      << "Select should return a value" << limitCopyResults.error();
...
TEST_F(ORMTest, QuerySetCopyAssignmentOperator) {
  ...
  auto query2 =
      QuerySet<Author>(conn).where(Field<&Author::rating>() > 4.0).limit(2);
  ...
  ASSERT_TRUE(originalQuery1Results.has_value())
      << "Select should return a value" << originalQuery1Results.error();
  ASSERT_TRUE(newQuery2Results.has_value())
      << "Select should return a value" << newQuery2Results.error();
  EXPECT_EQ(originalQuery1Results.value().size(),
            newQuery2Results.value().size());
  ...
  ASSERT_TRUE(finalQuery1Results.has_value())
      << "Select should return a value" << finalQuery1Results.error();
  EXPECT_EQ(originalQuery1Results.value().size(),
            finalQuery1Results.value().size());

  // Modified query2 should have different results
  ASSERT_TRUE(modifiedQuery2Results.has_value())
      << "Select should return a value" << modifiedQuery2Results.error();
  EXPECT_NE(originalQuery1Results.value().size(),
            modifiedQuery2Results.value().size());

  // Self-assignment test
  query1 = query1; // Self-assignment should be safe
  auto afterSelfAssignResults = query1.select_all();
  ASSERT_TRUE(afterSelfAssignResults.has_value())
      << "Select should return a value" << afterSelfAssignResults.error();
  EXPECT_EQ(originalQuery1Results.value().size(),
            afterSelfAssignResults.value().size());
}
...
TEST_F(ORMTest, QuerySetCopyEdgeCases) {
  ...
  ASSERT_TRUE(emptyQueryResults.has_value())
      << "Select should return a value" << emptyQueryResults.error();
  ASSERT_TRUE(emptyQueryCopyResults.has_value())
      << "Select should return a value" << emptyQueryCopyResults.error();
  EXPECT_EQ(emptyQueryResults.value().size(),
            emptyQueryCopyResults.value().size());

  // 2. Test copying a query with no results
  auto noResultsQuery = QuerySet<Author>(conn).where(Field<&Author::age>() >
                                                     100); // No one is that old
  ...
  ASSERT_TRUE(noResultsQueryResults.has_value())
      << "Select should return a value" << noResultsQueryResults.error();
  ASSERT_TRUE(noResultsQueryCopyResults.has_value())
      << "Select should return a value" << noResultsQueryCopyResults.error();
  EXPECT_EQ(noResultsQueryResults.value().size(),
            noResultsQueryCopyResults.value().size());
  ...
  ASSERT_TRUE(complexResults.has_value())
      << "Select should return a value" << complexResults.error();
  ASSERT_TRUE(complexCopyResults.has_value())
      << "Select should return a value" << complexCopyResults.error();
  ...
  if (!complexResults.value().empty() && !complexCopyResults.value().empty()) {
    ...
    EXPECT_EQ(complexResults.value()[0].name,
              complexCopyResults.value()[0].name);
  ...
  ASSERT_TRUE(copy1Result.has_value())
      << "Select should return a value" << copy1Result.error();
  ASSERT_TRUE(copy2Result.has_value())
      << "Select should return a value" << copy2Result.error();
  ASSERT_TRUE(copy3Result.has_value())
      << "Select should return a value" << copy3Result.error();
  ...
  ASSERT_TRUE(baseResults.has_value())
      << "Select should return a value" << baseResults.error();
  ASSERT_TRUE(copy1Results.has_value())
      << "Select should return a value" << copy1Results.error();
  ...
  ASSERT_TRUE(copy2Results.has_value())
      << "Select should return a value" << copy2Results.error();
  ...
  ASSERT_TRUE(copy3Results.has_value())
      << "Select should return a value" << copy3Results.error();
...
TEST_F(ORMTest, FullCRUDWorkflow) {
  ...
  auto result = QuerySet<Author>(conn).insert(author);
  ASSERT_TRUE(result.has_value())
      << "Insert should return a value" << result.error();
  int id = result.value();
  ASSERT_GT(id, 0);
...
TEST_F(ORMTest, MixedOperations) {
  ...
  ASSERT_TRUE(result2.has_value())
      << "Insert should return a value" << result2.error();
  ...
  ASSERT_TRUE(result.has_value())
      << "Update should return a value" << result.error();
  ...
  ASSERT_TRUE(result.has_value())
      << "Remove should return a value" << result.error();
  ASSERT_EQ(result.value(), true);
...
TEST_F(ORMTest, SelectAll) {
  ...
  ASSERT_TRUE(all_authors.has_value())
      << "Select should return a value" << all_authors.error();
  ASSERT_EQ(all_authors.value().size(), 4); // Alice, Bob, Charlie, Diana
}

TEST_F(ORMTest, SelectAllWhereId) {
  auto authors =
      QuerySet<Author>(conn).where<&Author::id>(alice_id).select_all();
  ASSERT_TRUE(authors.has_value())
      << "Select should return a value" << authors.error();
...
TEST_F(ORMTest, SelectAllWhereMany) {
  auto posts = QuerySet<Post>(conn)
                   ...
                   .select_all();
  ASSERT_TRUE(posts.has_value())
      << "Select should return a value" << posts.error();
...
TEST_F(ORMTest, SelectAllWithJoin) {
  ...
  ASSERT_TRUE(all_posts.has_value())
      << "Select should return a value" << all_posts.error();
...
TEST_F(ORMTest, OrderBySingleFieldAscendingExplicit) {
  auto authors =
      QuerySet<Author>(conn).order_by<&Author::name, true>().select_all();
...
TEST_F(ORMTest, OrderBySingleFieldDescending) {
  auto authors =
      QuerySet<Author>(conn).order_by<&Author::name, false>().select_all();
...
TEST_F(ORMTest, OrderByMultipleFieldsMixedDirections) {
  auto authors = QuerySet<Author>(conn)
                     .order_by<&Author::age, true, &Author::name,
...
TEST_F(ORMTest, OrderByAgeDescending) {
  auto authors =
      QuerySet<Author>(conn).order_by<&Author::age, false>().select_all();
...
TEST_F(ORMTest, WhereClauseNTTPSyntax) {
  auto authors =
      QuerySet<Author>(conn)
          .where<&Author::age>(
              30) // NTTP syntax - member pointer as template parameter
          .select_all();
...
TEST_F(ORMTest, WhereClauseNTTPWithOperators) {
  ...
  auto authors =
      QuerySet<Author>(conn).where<&Author::age>(25, Op::GT).select_all();
...
TEST_F(ORMTest, WhereClauseNTTPLikeOperator) {
  auto authors = QuerySet<Author>(conn)
                     .where<&Author::name>(std::string("A%"),
                                           Op::LIKE) // Names starting with 'A'
                     .select_all();
...
TEST_F(ORMTest, WhereClauseNTTPWithArithmeticTypes) {
  ...
  ASSERT_TRUE(authorsInt.has_value())
      << "Select should return a value" << authorsInt.error();
  ASSERT_EQ(authorsInt.value().size(), 1);
  auto authorsIntValue = authorsInt.value();

  ASSERT_TRUE(authorsDouble.has_value())
      << "Select should return a value" << authorsDouble.error();
  ASSERT_EQ(authorsDouble.value().size(), 1);
  auto authorsDoubleValue = authorsDouble.value();

  ASSERT_TRUE(authorsFloat.has_value())
      << "Select should return a value" << authorsFloat.error();
...
TEST_F(ORMTest, WhereClauseNTTPComparisonWithTraditional) {
  ...
  auto authorsTraditional =
      QuerySet<Author>(conn).where<&Author::age>(30, Op::EQ).select_all();

  ASSERT_TRUE(authorsTraditional.has_value())
      << "Select should return a value" << authorsTraditional.error();
  ...
  ASSERT_TRUE(authorsNTTP.has_value())
      << "Select should return a value" << authorsNTTP.error();
  ...
  for (size_t i = 0; i < authorsTraditional.value().size(); ++i) {
    ...
    EXPECT_EQ(authorsTraditional.value()[i].is_active,
              authorsNTTP.value()[i].is_active);
  }
}
...
TEST_F(ORMTest, WhereClauseLessOrEqualOperator) {
  ...
  auto authors =
      QuerySet<Author>(conn).where<&Author::age>(30, Op::LE).select_all();
...
TEST_F(ORMTest, WhereClauseGreaterOrEqualOperator) {
  ...
  auto authors =
      QuerySet<Author>(conn).where<&Author::age>(25, Op::GE).select_all();
...
TEST_F(ORMTest, WhereClauseNTTPLessOrEqual) {
  ...
  auto authors =
      QuerySet<Author>(conn).where<&Author::age>(35, Op::LE).select_all();
...
TEST_F(ORMTest, WhereClauseNTTPGreaterOrEqual) {
  ...
  auto authors =
      QuerySet<Author>(conn).where<&Author::rating>(3.0, Op::GE).select_all();
...
TEST_F(ORMTest, WhereClauseIsOperator) {
  ...
  auto stmt = Statement(conn, "INSERT INTO author (name, age, email, "
  ...
  auto authors = QuerySet<Author>(conn)
                     .where<&Author::biography>(
                         std::nullopt, Op::IS) // WHERE biography IS NULL
                     .select_all();
...
TEST_F(ORMTest, WhereNotNull) {
  ...
  auto authors =
      QuerySet<Author>(conn).where_not_null<&Author::biography>().select_all();
...
TEST_F(ORMTest, ComparisonWithExplicitCondition) {
  ...
  ASSERT_TRUE(authors1.has_value())
      << "First query should return a value" << authors1.error();
  ASSERT_TRUE(authors2.has_value())
      << "Second query should return a value" << authors2.error();
...
TEST_F(ORMTest, WhereClauseNestedComplexGrouping) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where((Field<&Author::age>() == 25 or
                             Field<&Author::age>() == 35) and // NOSONAR
                            (Field<&Author::rating>() >= 4.5 or
                             Field<&Author::score>() >= 90.0)) // NOSONAR
                     .select_all();
...
TEST_F(ORMTest, WhereClauseComplexNestedConditions) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where(((Field<&Author::age>() < 30 and
                              Field<&Author::rating>() > 4.0) or // NOSONAR
                             (Field<&Author::age>() >= 30 and
                              Field<&Author::score>() >= 85.0)) and
...
TEST_F(ORMTest, WhereClauseStringOperations) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where((Field<&Author::name>().like("%Brown") or
                             Field<&Author::email>().like("%alice%")) and
...
TEST_F(ORMTest, WhereClauseFloatComparisons) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where((Field<&Author::score>() >= 85.0 and
                             Field<&Author::score>() <= 90.0) or
                            Field<&Author::rating>() > 5.0) // NOSONAR
                     .select_all();
...
TEST_F(ORMTest, WhereClauseComplexChaining) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where(((Field<&Author::age>() >= 25 and
                              Field<&Author::age>() <= 30) or // NOSONAR
                             (Field<&Author::rating>() >= 5.0 and
                              Field<&Author::score>() >= 90.0) or // NOSONAR
...
TEST_F(ORMTest, WhereClauseEmptyResult) {
  ...
  auto authors = QuerySet<Author>(conn)
                     .where(Field<&Author::age>() > 100 or // NOSONAR
                            (Field<&Author::rating>() < 0 and
                             Field<&Author::is_active>() == false)) // NOSONAR
                     .select_all();
...
TEST_F(ORMTest, SelectValues) {
  ...
  ASSERT_TRUE(result.has_value())
      << "select_values failed with error: " << result.error();
...
TEST_F(ORMTest, DistinctTemplateBased) {
  ...
  auto distinctAgeValues =
      QuerySet<Author>(conn).distinct<&Author::age>().select_values();

  // Check if we got a valid result
  ASSERT_TRUE(distinctAgeValues.has_value())
      << "select_values failed with error: " << distinctAgeValues.error();

  ASSERT_TRUE(allAuthors.has_value())
      << "select_all failed with error: " << allAuthors.error();
  ...
  ASSERT_TRUE(distinctAgesSet.contains(
      30)); // Charlie and Frank (both should be returned)
...
TEST_F(ORMTest, DistinctMultipleFields) {
  ...
  // Check if we got a valid result
  ASSERT_TRUE(distinctValues.has_value())
      << "select_values failed with error: " << distinctValues.error();
  ...
  ASSERT_TRUE(distinctCombinations.contains(
      std::make_pair(25, 4.5))); // Alice and clone
  ASSERT_TRUE(distinctCombinations.contains(std::make_pair(25, 0.0))); // Greg
  ASSERT_TRUE(
      distinctCombinations.contains(std::make_pair(35, 5.0))); // Bob and Helen
  ASSERT_TRUE(
      distinctCombinations.contains(std::make_pair(30, 4.0))); // Charlie
...
TEST_F(ORMTest, DistinctWithWhere) {
  ...
  // Check if we got a valid result
  ASSERT_TRUE(authorResults.has_value())
      << "select_values failed with error: " << authorResults.error();
  ...
  ASSERT_TRUE(
      distinctAges.contains(40)); // Jack and Kate (but only counted once)
...
TEST_F(ORMTest, RawSqlFromStatementInsert) {
  ...
  ASSERT_TRUE(rawSql.find(expectedSqlPattern) == 0)
      << "SQL should start with '" << expectedSqlPattern
      << "' but got: " << rawSql;

  // Check for field names in the SQL
  ASSERT_TRUE(rawSql.find("name") != std::string::npos)
      << "SQL should contain 'name' field";
  ASSERT_TRUE(rawSql.find("age") != std::string::npos)
      << "SQL should contain 'age' field";
  ASSERT_TRUE(rawSql.find("email") != std::string::npos)
      << "SQL should contain 'email' field";
  ...
  ASSERT_EQ(questionMarkCount, 8)
      << "Expected 8 placeholders but found " << questionMarkCount;
  ...
  ASSERT_TRUE(authorId.has_value())
      << "insert failed with error: " << authorId.error();
  ...
  ASSERT_TRUE(multiRawSql.find(expectedSqlPattern) == 0)
      << "Multi SQL should start with '" << expectedSqlPattern
      << "' but got: " << multiRawSql;
  ...
  ASSERT_EQ(questionMarkCount, 16)
      << "Expected 16 placeholders (8 per author) but found "
      << questionMarkCount;
...
TEST_F(ORMTest, GroupByBasic) {
  ...
  ASSERT_TRUE(results.has_value())
      << "query failed with error: " << results.error();
...
TEST_F(ORMTest, GroupByWithJoinAndWhere) {
  ...
  Post post7("Another Post by Charlie", "More content from Charlie",
             charlie_id);
...
TEST_F(ORMTest, BasicTransactionCommit) {
  ...
  ASSERT_TRUE(alice_id.has_value())
      << "query failed with error: " << alice_id.error();
...
TEST_F(ORMTest, TransactionLevels) {
  ...
  ASSERT_TRUE(bob_id.has_value())
      << "query failed with error: " << bob_id.error();
...
TEST_F(ORMTest, MultipleOperationsInTransaction) {
  ...
  ASSERT_TRUE(charlie_id.has_value())
      << "query failed with error: " << charlie_id.error();

  // Update an author - first retrieve the current object with the correct ID
  auto result =
      QuerySet<Author>(conn).where<&Author::id>(alice_id.value()).select_one();
  ASSERT_TRUE(result.has_value())
      << "query failed with error: " << result.error();
  auto alice_from_db = result.value();
  alice_from_db.age = 26;
  auto update_result = QuerySet<Author>(conn).update(alice_from_db);
  ASSERT_TRUE(update_result.has_value())
      << "query failed with error: " << update_result.error();
...
TEST_F(ORMTest, TransferBetweenAuthorsTransaction) {
  ...
  Post alicePost("Alice's Original Post", "This post belongs to Alice",
                 alice_id, 0, 100);
  ...
  // to ensure the operation is atomic
  {
    ...
    try {
      ...
      ASSERT_TRUE(post.has_value())
          << "query failed with error: " << post.error();
  ...
  ASSERT_TRUE(updatedPost.has_value())
      << "query failed with error: " << updatedPost.error();
...
TEST_F(ORMTest, MaxStringField) {
  ...
  auto result =
      QuerySet<Author>(conn).max<&Author::name>("max_name").select_values();
...
TEST_F(ORMTest, MaxOnEmptyTable) {
  ...
  auto result =
      QuerySet<Author>(conn).max<&Author::age>("max_age").select_values();
...
TEST_F(ORMTest, MultipleMaxFunctions) {
  ...
  ValueVectorMap expected_results = {
      {{"max_age", 35}, {"max_rating", 5.5}, {"max_score", 95}}};
  AssertResultsMatch(result, expected_results);
}
...
TEST_F(ORMTest, MaxValue) {
  ...
  ASSERT_TRUE(result.has_value())
      << "max_value failed with error: " << result.error();
...
TEST_F(ORMTest, MaxValueWithFilter) {
  ...
  ASSERT_TRUE(result.has_value())
      << "max_value with filter failed with error: " << result.error();
  EXPECT_EQ(result.value(), 35);
}
...
TEST_F(ORMTest, MaxValueEmptyTable) {
  ...
  auto result = QuerySet<Author>(conn).max_value<&Author::age>();
  ASSERT_TRUE(result.has_value())
      << "max_value on empty table should return 0, not an error";
...
TEST_F(ORMTest, MinStringField) {
  auto result =
      QuerySet<Author>(conn).min<&Author::name>("min_name").select_values();
...
TEST_F(ORMTest, MinOnEmptyTable) {
  ...
  auto result =
      QuerySet<Author>(conn).min<&Author::age>("min_age").select_values();
...
TEST_F(ORMTest, MultipleMinFunctions) {
  ...
  ValueVectorMap expected_results = {
      {{"min_age", 25}, {"min_rating", 4.0}, {"min_score", 80}}};
  AssertResultsMatch(result, expected_results);
}
...
TEST_F(ORMTest, MinValue) {
  ...
  ASSERT_TRUE(result.has_value())
      << "min_value failed with error: " << result.error();
...
TEST_F(ORMTest, MinValueWithFilter) {
  ...
  ASSERT_TRUE(result.has_value())
      << "min_value with filter failed with error: " << result.error();
  EXPECT_EQ(result.value(), 35);
}
...
TEST_F(ORMTest, MinValueEmptyTable) {
  ...
  auto result = QuerySet<Author>(conn).min_value<&Author::age>();
  ASSERT_TRUE(result.has_value())
      << "min_value on empty table should return 0, not an error";
...
TEST_F(ORMTest, MinValueWithJoin) {
  ...
  ASSERT_TRUE(result.has_value())
      << "min_value with join failed with error: " << result.error();
  EXPECT_EQ(result.value(), 4.0);
}
...
TEST_F(ORMTest, AvgNumericField) {
  auto result =
      QuerySet<Author>(conn).avg<&Author::age>("avg_age").select_values();
...
TEST_F(ORMTest, AvgWithGroupBy) {
  ...
  ValueVectorMap expected_results = {{{"age", 25}, {"avg_rating", 4.5}},
...
TEST_F(ORMTest, CombineAvgMinMaxWithGroupBy) {
  ...
  ValueVectorMap expected_results = {{{"age", 25},
                                      {"avg_rating", 4.5},
                                      {"min_rating", 4.5},
                                      {"max_rating", 4.5}},
                                     {{"age", 28},
...
TEST_F(ORMTest, AvgValueInt) {
  ...
  ASSERT_TRUE(result.has_value())
      << "avg failed with error: " << result.error();
...
TEST_F(ORMTest, AvgValueWithFilter) {
  ...
  ASSERT_TRUE(result.has_value())
      << "avg with filter failed with error: " << result.error();
...
TEST_F(ORMTest, AvgValueDouble) {
  ...
  ASSERT_TRUE(result.has_value())
      << "avg of double failed with error: " << result.error();
...
TEST_F(ORMTest, AvgValueFloat) {
  ...
  ASSERT_TRUE(result.has_value())
      << "avg of float failed with error: " << result.error();
...
TEST_F(ORMTest, AvgValueWithJoin) {
  ...
  ASSERT_TRUE(result.has_value())
      << "avg_value with join failed with error: " << result.error();
  EXPECT_EQ(result.value(), 4.0);
}
...
TEST_F(ORMTest, AvgValueEmptyTable) {
  ...
  auto result = QuerySet<Author>(conn).avg_value<&Author::age>();
  ASSERT_TRUE(result.has_value())
      << "avg_value on empty table should return 0.0, not an error";
  ASSERT_DOUBLE_EQ(result.value(), 0.0)
      << "avg_value on empty table should return 0.0";
}
...
TEST_F(ORMTest, CountWithCustomAlias) {
  auto result =
      QuerySet<Author>(conn).count<&Author::id>("author_count").select_values();
...
TEST_F(ORMTest, CountWithGroupBy) {
  ...
  Author duplicate("Duplicate Author", 30, "duplicate@example.com", 0, true,
                   4.2, 82.0);
  ...
  ValueVectorMap expected_results = {{{"age", 25}, {"count_id", 1}},
                                     {{"age", 28}, {"count_id", 1}},
                                     {{"age", 30}, {"count_id", 2}},
                                     {{"age", 35}, {"count_id", 1}}};
  AssertResultsMatch(result, expected_results);
...
TEST_F(ORMTest, CountValue) {
  ...
  ASSERT_TRUE(result.has_value())
      << "count_value failed with error: " << result.error();
...
TEST_F(ORMTest, CountValueString) {
  ...
  ASSERT_TRUE(result.has_value())
      << "count_value with join failed with error: " << result.error();
...
TEST_F(ORMTest, CountValueWithFilter) {
  ...
  ASSERT_TRUE(result.has_value())
      << "count_value with filter failed with error: " << result.error();
...
TEST_F(ORMTest, CountValueEmptyTable) {
  ...
  auto result = QuerySet<Author>(conn).count_value<&Author::id>();
  ASSERT_TRUE(result.has_value())
      << "count_value with empty table failed with error: " << result.error();
...
TEST_F(ORMTest, SumWithCustomAlias) {
  auto result =
      QuerySet<Author>(conn).sum<&Author::age>("total_age").select_values();
...
TEST_F(ORMTest, SumWithGroupBy) {
  ...
  ValueVectorMap expected_results = {{{"age", 25}, {"sum_rating", 4.5}},
...
TEST_F(ORMTest, SumValue) {
  ...
  ASSERT_TRUE(result.has_value())
      << "sum_value failed with error: " << result.error();
...
TEST_F(ORMTest, SumValueWithFilter) {
  ...
  ASSERT_TRUE(result.has_value())
      << "sum_value with filter failed with error: " << result.error();
...
TEST_F(ORMTest, SumValueEmptyTable) {
  ...
  auto result = QuerySet<Author>(conn).sum_value<&Author::age>();
  ASSERT_TRUE(result.has_value())
      << "sum_value on empty table should return 0, not an error";
...
TEST_F(ORMTest, SumValueDouble) {
  ...
  ASSERT_TRUE(result.has_value())
      << "sum_value with join failed with error: " << result.error();
...
TEST_F(ORMTest, WhereClauseCollateNocase) {
  ...
  QuerySet<Author>(conn).insert(
      std::vector{author1, author2, author3, author4});
  ...
  ASSERT_TRUE(result.has_value())
      << "where clause collate nocase failed with error: " << result.error();
  auto value = result.value();
  ASSERT_EQ(value.size(), 1);
  EXPECT_EQ(value[0].name, "BOB");

  // Without COLLATE, the case-sensitive search would find nothing
  auto result_case_sensitive =
      QuerySet<Author>(conn).where<&Author::name>("bob").select_all();

  ASSERT_TRUE(result_case_sensitive.has_value())
      << "where clause collate nocase failed with error: "
      << result_case_sensitive.error();
...
TEST_F(ORMTest, WhereClauseCollateRtrim) {
  ...
  ASSERT_TRUE(result.has_value())
      << "where clause collate rtrim failed with error: " << result.error();
  auto value = result.value();
  ASSERT_EQ(value.size(), 1);
  EXPECT_EQ(value[0].name, "Alice  ");

  // Without COLLATE RTRIM, the search would find nothing
  auto result_without_rtrim =
      QuerySet<Author>(conn).where<&Author::name>("Alice").select_all();

  ASSERT_TRUE(result_without_rtrim.has_value())
      << "where clause collate rtrim failed with error: "
      << result_without_rtrim.error();
...
TEST_F(ORMTest, WhereClauseCollateBinary) {
  ...
  ASSERT_TRUE(result.has_value())
      << "where clause collate binary failed with error: " << result.error();
  auto value = result.value();
  ASSERT_EQ(value.size(), 1);
  EXPECT_EQ(value[0].name, "Alice");
...
TEST_F(ORMTest, OrderByCollateNocase) {
  ...
  ASSERT_TRUE(result.has_value())
      << "order by collate nocase failed with error: " << result.error();
  auto value = result.value();
  ...
  auto result_binary =
      QuerySet<Author>(conn).order_by<&Author::name>().select_all();

  ASSERT_TRUE(result_binary.has_value())
      << "order by collate nocase failed with error: " << result_binary.error();
...
TEST_F(ORMTest, OrderByCollateRtrim) {
  ...
  ASSERT_TRUE(result.has_value())
      << "order by collate rtrim failed with error: " << result.error();
  auto value = result.value();
...
TEST_F(ORMTest, OrderByCollateBinary) {
  ...
  QuerySet<Author>(conn).insert(
      std::vector{author1, author2, author3, author4, author5});
  ...
  ASSERT_TRUE(result.has_value())
      << "order by collate binary failed with error: " << result.error();
  auto value = result.value();
...
TEST_F(ORMTest, OrderByMultipleFieldsWithCollation) {
  ...
  auto result = QuerySet<Author>(conn)
                    .order_by_collate<&Author::name, true, Collation::NOCASE,
                                      &Author::age, false, Collation::NONE>()
                    .select_all();
...
TEST_F(ORMTest, CollateInWhereAndOrderBy) {
  ...
  ASSERT_TRUE(result.has_value())
      << "collate in where and order by failed with error: " << result.error();
  auto value = result.value();
...
TEST_F(ORMTest, WhereClauseMultipleCollateOperations) {
  ...
  ASSERT_TRUE(result1.has_value())
      << "NOCASE collation failed: " << result1.error();
  ...
  ASSERT_TRUE(result2.has_value())
      << "RTRIM collation failed: " << result2.error();
  ...
  ASSERT_TRUE(result3.has_value())
      << "Multiple collate OR condition failed: " << result3.error();
  ...
  const auto &result4 =
      QuerySet<Author>(conn)
          .where((Field<&Author::name>().collate_nocase() == "alice" &&
                  Field<&Author::age>() == 25) ||
                 (Field<&Author::name>().collate_binary() == "DIANA" &&
                  Field<&Author::age>() > 30))
          .select_all();

  ASSERT_TRUE(result4.has_value())
      << "Complex collate condition failed: " << result4.error();
  ...
  ASSERT_TRUE(result5.has_value())
      << "Collate with LIKE pattern failed: " << result5.error();
  ...
  ASSERT_TRUE(result6.has_value())
      << "Chained collate with boolean failed: " << result6.error();
  ...
  const auto &result7 =
      QuerySet<Author>(conn)
          .where(Field<&Author::name>().collate_nocase().in(
                     {"alice", "bob", "charlie"}) &&
                 (Field<&Author::name>().collate_rtrim().like("%e%") ||
                  Field<&Author::age>() < 30))
          .select_all();

  ASSERT_TRUE(result7.has_value())
      << "Nested collate conditions failed: " << result7.error();
  ...
  const auto &result8 =
      QuerySet<Author>(conn)
          .where(Field<&Author::name>().collate_nocase().startswith("a") &&
                 Field<&Author::email>().collate_nocase().endswith(
                     "@EXAMPLE.COM") &&
                 Field<&Author::age>() >= 25)
          .select_all();

  ASSERT_TRUE(result8.has_value())
      << "Mixed collate operations failed: " << result8.error();
...
TEST_F(ORMTest, GroupConcatBasic) {
  ...
  ASSERT_TRUE(result.has_value())
      << "Basic GROUP_CONCAT failed: " << result.error();
  ...
  std::string alicePosts =
      std::get<std::string>(aliceIt->at("group_concat_title"));
...
TEST_F(ORMTest, GroupConcatCustomSeparator) {
  ...
  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with custom separator failed: " << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 4); // Alice, Bob, Charlie, Diana
  ...
  std::string bobPosts =
      std::get<std::string>(bobIt->at("custom_group_concat_title"));
...
TEST_F(ORMTest, GroupConcatDistinct) {
  ...
  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with DISTINCT failed: " << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 4);
  ...
  QuerySet<Post>(conn)
      .where(Field<&Post::title>() == "Alice's First Post" &&
             Field<&Post::content>() == "Duplicate content")
      .remove();
}
...
TEST_F(ORMTest, GroupConcatOrderByAscending) {
  ...
  auto result = QuerySet<Post>(conn)
                    ...
                    .group_concat_order<&Post::id, &Post::title>(
                        "", ",", " ",
                        false) // Field = &Post::title, OrderField = &Post::id
                    .only<&Post::author_id>()
                    .select_values();

  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with ORDER BY failed: " << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 4);
  ...
  std::string charliePosts =
      std::get<std::string>(charlieIt->at("group_concat_title"));
  ...
  EXPECT_LT(firstPostPos, fourthPostPos)
      << "Posts not ordered correctly in ascending order";
}
...
TEST_F(ORMTest, GroupConcatOrderMultipleFields) {
  ...
  auto result =
      QuerySet<Post>(conn)
          ...
          .group_concat_order<&Post::id, &Post::title, &Post::content>(
              "title_content_by_id", ",", " - ",
              false) // OrderField = &Post::id, Fields = &Post::title,
                     // &Post::content
          .only<&Post::author_id>()
          .select_values();

  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with multiple fields and ORDER BY failed: "
      << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 4);
  ...
  std::string charliePosts =
      std::get<std::string>(charlieIt->at("title_content_by_id"));
...
TEST_F(ORMTest, GroupConcatMultipleFields) {
  ...
  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with multiple fields failed: " << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 1);
  ASSERT_TRUE(value[0].contains("title_content"));

  std::string concatenated =
      std::get<std::string>(value[0].at("title_content"));
  ...
  EXPECT_TRUE(concatenated.find("Charlie's First Post - ") !=
              std::string::npos);
...
TEST_F(ORMTest, GroupConcatMultipleFieldsWithGroupBy) {
  ...
  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with multiple fields and GROUP BY failed: "
      << result.error();
  const auto &value = result.value();
...
TEST_F(ORMTest, GroupConcatDistinctMultipleFields) {
  ...
  auto result = QuerySet<Post>(conn)
                    .group_by<&Post::author_id>()
                    .group_concat<&Post::title, &Post::content>(
                        "title_content", "", " - ", true) // distinct = true
                    .only<&Post::author_id>()
                    .select_values();

  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT DISTINCT with multiple fields failed: "
      << result.error();
  const auto &value = result.value();
...
TEST_F(ORMTest, GroupConcatSingleFieldBasic) {
  ...
  auto result =
      QuerySet<Post>(conn).group_concat<&Post::title>().select_values();
  ...
  std::string concatenated =
      std::get<std::string>(value[0].at("group_concat_title"));
...
TEST_F(ORMTest, GroupConcatWithCustomAlias) {
  ...
  ASSERT_TRUE(result.has_value())
      << "GROUP_CONCAT with custom alias failed: " << result.error();
  const auto &value = result.value();
  ASSERT_EQ(value.size(), 1);
  ASSERT_TRUE(value[0].contains("my_custom_alias"));

  std::string concatenated =
      std::get<std::string>(value[0].at("my_custom_alias"));
  EXPECT_FALSE(concatenated.empty());
}
