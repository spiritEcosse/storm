 ...
 */
#include "../../shared/models/person.h" // NOSONAR cpp:S954 — Person-typed FK members below
#include <meta>
...
// not exist. `Person` comes from shared/models/person.h, included above.
struct StockEntry {
...
// from shared/models/person.h), so:
