...
// This TU supplies the PostgreSQL half of test_composite_fk_join_body.h;
// test_composite_fk_join_sqlite.cpp supplies the other half. See that header's own comment
