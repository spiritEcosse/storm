...
export namespace storm {
    ...
    struct AggregateSpec {
        ...
        template<auto Field>
        static AggregateSpec max(std::string_view alias = {}) {
        ...
        template<auto Field>
        static AggregateSpec min(std::string_view alias = {}) {
            static_assert(std::is_member_pointer_v<decltype(Field)>, "Field must be a member pointer");
            auto field_wrapper = refl::FieldWrapper::create<Field>();
            return AggregateSpec{
        ...
        template<auto Field>
        static AggregateSpec avg(std::string_view alias = {}) {
            static_assert(std::is_member_pointer_v<decltype(Field)>, "Field must be a member pointer");
        ...
        template<auto Field>
        static AggregateSpec count(std::string_view alias = {}) {
            static_assert(std::is_member_pointer_v<decltype(Field)>, "Field must be a member pointer");
            auto field_wrapper = refl::FieldWrapper::create<Field>();
            return AggregateSpec{
        ...
        template<auto Field>
        static AggregateSpec sum(std::string_view alias = {}) {
            static_assert(std::is_member_pointer_v<decltype(Field)>, "Field must be a member pointer");
        ...
        [[nodiscard]] std::string to_sql() const {
            ...
            switch (kind) {
                case AggregateKind::Max:   function_name = "MAX"; break;
                case AggregateKind::Min:   function_name = "MIN"; break;
                case AggregateKind::Avg:   function_name = "AVG"; break;
                case AggregateKind::Count: function_name = "COUNT"; break;
                case AggregateKind::Sum:   function_name = "SUM"; break;
            }
            ...
            const auto actual_alias = alias ? *alias : std::format("{}_{}", 
                                                                   function_name == "MAX" ? "max" :
                                                                   function_name == "MIN" ? "min" :
                                                                   function_name == "AVG" ? "avg" :
                                                                   function_name == "COUNT" ? "count" : "sum",
                                                                   simple_field_name);
