...
namespace storm {
    ...
    const std::unordered_map<std::string, SqlValue, TransparentStringHash, std::equal_to<>>&
    ...
    SqlValue ParameterBinder::get_parameter_value(const std::string& param_name) const {
