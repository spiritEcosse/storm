...
namespace {
    ...
    auto print_help() -> void {
        ...
        std::printf(
                ...
                "\n"
                "Session line format:\n"
                "  ▼ [N] filter='…' · K results · complete HH:MM:SS UTC\n"
                "  K is the count of per-iteration measurement rows only.\n"
                "  Big-O and RMS aggregate rows fold into the per-category\n"
                "  Complexity: footer and are not counted in K.\n"
                "\n"
