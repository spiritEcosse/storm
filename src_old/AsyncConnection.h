...
public:
    ...
    Task<bool> connectAsync() {
        bool result = co_await DatabaseAwaitable<bool>([this]() {
    ...
    Task<bool> executeAsync(const std::string& query) {
        bool result = co_await DatabaseAwaitable<bool>([this, query]() {
    ...
    Task<ResultSet> executeQueryAsync(const std::string& query) {
        ResultSet result = co_await DatabaseAwaitable<ResultSet>([this, query]() {
    ...
    Task<void> beginTransactionAsync() {
        co_await DatabaseAwaitable<void>([this]() {
